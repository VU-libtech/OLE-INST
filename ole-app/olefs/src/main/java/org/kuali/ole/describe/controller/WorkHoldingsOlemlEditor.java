...
//                bibTree.getHoldingsTrees().addAll(holdingsTreeList);
        ...
        try {
            HoldingsTree holdingsTree = docstoreClient.retrieveHoldingsTree(editorForm.getDocId());
            String holdingLocation = instanceEditorFormDataHandler.getLocationCode(workInstanceOlemlForm.getSelectedHolding().getLocation().getLocationLevel());
            String callNumber;
            String prefix;
