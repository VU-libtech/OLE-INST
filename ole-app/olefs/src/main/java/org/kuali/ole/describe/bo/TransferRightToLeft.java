    ...
    public void transferRightToLeft(BoundwithForm transferForm, BindingResult result, HttpServletRequest request,
        ...
        if (leftTreeRootElement == null) {
            ...
            if (transferInstance) {
                ...
                TransferUtil.getInstance().copyToTree(transferForm, bibIdentifierListForRightTree, "rightTree");
                TransferUtil.getInstance().copyToTree(transferForm, bibIdentifierListForLeftTree, "leftTree");
