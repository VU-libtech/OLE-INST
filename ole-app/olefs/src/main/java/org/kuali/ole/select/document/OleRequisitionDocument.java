...
/*    private void setItemDescription(OleRequisitionItem oleRequisitionItem, Bib newBib){
    ...
    private List<OleCopy> getCopyList(OleRequisitionItem singleItem){
        ...
        List<OleCopy> oleCopyList = getOleCopyHelperService().setCopyValuesForList(itemCopies, singleItem.getItemTitleId(), singleItem.getBibTree());
    ...
    private void populateCopiesSection(OleRequisitionItem singleItem) {
        if (singleItem.getCopies().size() > 0) {
            List<OleCopy> copyList = getOleCopyHelperService().setCopyValuesForList(singleItem.getCopies(), singleItem.getItemTitleId(), null);
