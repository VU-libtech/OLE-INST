...
INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('PATRON_VIEW_ALTER', 'ole', 'org/kuali/ole/1.6.0/db.changelog-20141207.xml', NOW(), 29, '7:7a372a904df92603789f33e5b943fcdb', 'createView', '', 'EXECUTED', '3.2.0')
/
