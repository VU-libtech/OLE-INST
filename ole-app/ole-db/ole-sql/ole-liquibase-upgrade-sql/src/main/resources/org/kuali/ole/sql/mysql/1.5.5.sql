...
CREATE TABLE OLE_DS_BIB_INFO_T (BIB_ID VARCHAR(20) NULL, AUTHOR VARCHAR(4000) NULL, TITLE VARCHAR(4000) NULL, PUBLISHER VARCHAR(4000) NULL, ISXN VARCHAR(100) NULL)
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_DS_BIB_INFO_T', 'ole', 'org/kuali/ole/1.5.5/db.changelog-20141015.xml', NOW(), 3, '7:982a896125ccefe865485b3c71acebb4', 'createTable', '', 'EXECUTED', '3.2.0')
/

--  Changeset org/kuali/ole/1.5.5/db.changelog-20141015.xml::OLE_DS_BIB_INFO_T_PK::ole
ALTER TABLE OLE_DS_BIB_INFO_T ADD PRIMARY KEY (BIB_ID)
/

INSERT INTO DATABASECHANGELOG (ID, AUTHOR, FILENAME, DATEEXECUTED, ORDEREXECUTED, MD5SUM, DESCRIPTION, COMMENTS, EXECTYPE, LIQUIBASE) VALUES ('OLE_DS_BIB_INFO_T_PK', 'ole', 'org/kuali/ole/1.5.5/db.changelog-20141015.xml', NOW(), 4, '7:069e7f60e9957efca82352bc5ef9e71a', 'addPrimaryKey', '', 'EXECUTED', '3.2.0')
/
